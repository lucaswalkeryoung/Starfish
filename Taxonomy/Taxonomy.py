...
def partition(attributes: dict[str, int]) -> dict[type, dict[str, int]]:
    ...
    for attribute, value in attributes.items():
        output[SINGULAR_TO_ATOM[attribute]][attribute] = value
...
from Ontology.Atoms.Operation import Operation
...
from Ontology.Components.Conditions import Conditions
from Ontology.Components.Condition import Condition
from Ontology.Components.Cost import Cost
...
from Ontology.Shorthand.Colors.Gold import Gold
